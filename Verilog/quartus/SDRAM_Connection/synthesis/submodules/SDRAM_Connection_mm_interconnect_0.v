// SDRAM_Connection_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module SDRAM_Connection_mm_interconnect_0 (
		input  wire        pll_sdram_clk_outclk0_clk,                                       //                                     pll_sdram_clk_outclk0.clk
	...
	wire         jtag_master_master_translator_avalon_universal_master_0_waitrequest;   // sdram_controller_s1_translator:uav_waitrequest -> jtag_master_master_translator:uav_waitrequest
	wire  [31:0] jtag_master_master_translator_avalon_universal_master_0_readdata;      // sdram_controller_s1_translator:uav_readdata -> jtag_master_master_translator:uav_readdata
	wire         jtag_master_master_translator_avalon_universal_master_0_debugaccess;   // jtag_master_master_translator:uav_debugaccess -> sdram_controller_s1_translator:uav_debugaccess
	wire  [31:0] jtag_master_master_translator_avalon_universal_master_0_address;       // jtag_master_master_translator:uav_address -> sdram_controller_s1_translator:uav_address
	wire         jtag_master_master_translator_avalon_universal_master_0_read;          // jtag_master_master_translator:uav_read -> sdram_controller_s1_translator:uav_read
	wire   [3:0] jtag_master_master_translator_avalon_universal_master_0_byteenable;    // jtag_master_master_translator:uav_byteenable -> sdram_controller_s1_translator:uav_byteenable
	wire         jtag_master_master_translator_avalon_universal_master_0_readdatavalid; // sdram_controller_s1_translator:uav_readdatavalid -> jtag_master_master_translator:uav_readdatavalid
	wire         jtag_master_master_translator_avalon_universal_master_0_lock;          // jtag_master_master_translator:uav_lock -> sdram_controller_s1_translator:uav_lock
	wire         jtag_master_master_translator_avalon_universal_master_0_write;         // jtag_master_master_translator:uav_write -> sdram_controller_s1_translator:uav_write
	wire  [31:0] jtag_master_master_translator_avalon_universal_master_0_writedata;     // jtag_master_master_translator:uav_writedata -> sdram_controller_s1_translator:uav_writedata
	wire   [2:0] jtag_master_master_translator_avalon_universal_master_0_burstcount;    // jtag_master_master_translator:uav_burstcount -> sdram_controller_s1_translator:uav_burstcount
